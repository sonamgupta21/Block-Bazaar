    ...
    <header className="fixed z-50 w-screen p-3 md:p-4 px-4 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link className="flex items-center gap-2" to={"/"}>
          ...
          <SiBlockchaindotcom className="text-2xl text-headingColor" />
        ...
        <motion.ul className="flex items-center gap-12">
          <li className="text-base text-textColor hover:text-headingColor hover:font-bold duration-100 transition-all ease-in-out cursor-pointer ">
      ...
      <div className="flex md:hidden w-full items-center justify-between h-full">
        ...
        <Link to={"/"} className="flex items-center gap-2">
          <img src={logo} className="w-8 object-cover" alt="logo" />
          <p className="text-headingColor text-xl font-bold">Block-Bazaar</p>
        </Link>

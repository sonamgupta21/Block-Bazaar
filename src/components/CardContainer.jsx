  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between">
        ...
        <motion.div
          whileTap={{ scale: 0.75 }}
          className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center cursor-pointer hover:shadow-md"
      ...
      >
        ...
        {flag && (
          <div className=" flex items-end flex-col justify-center">
            <p className="text-sm text-blue-500 mb-1 capitalize">
              {item.category}
            </p>
        ...
        <div className="w-full flex items-center gap-8 justify-between">
          <p className="mt-1 text-sm text-gray-500 flex items-center justify-center gap-1">
            {item?.productID} <BiBarcodeReader className="text-sm text-yellow-400" />
          </p>
